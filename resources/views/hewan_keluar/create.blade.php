...
<section class="section">
  <div class="row">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="col-md-6">
             ...
             <!-- Vertical Form -->
             <form action="{{ route('hewan_keluar.store') }}" method="POST" enctype="multipart/form-data" class="row g-3">
    @csrf
    <div class="col-12">
    ...
    <div class="col-12">
        ...
        <input type="text" class="form-control" id="asal_hewan" name="asal_hewan" required>
    </div>
    <div class="col-12">
    ...
    <div class="col-12">
        <label for="pemilik_pengantar" class="form-label">Pemilik Hewan</label>
        <input type="text" class="form-control" id="pemilik_pengantar" name="pemilik_pengantar" required>
    </div>
    <div class="col-12">
