  ...
  <div class="row">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="col-md-6">
             ...
             <!-- Vertical Form -->
             <form action="{{ route('hewan_keluar.update', $data->id) }}" method="POST" enctype="multipart/form-data" class="row g-3">
    @csrf
    @method('PUT')
    ...
    <div class="col-12">
        ...
        <input type="date" class="form-control" id="tanggalKeluar" name="tanggal_keluar" 
               value="{{ old('tanggal_keluar', $data->tanggal_keluar->format('Y-m-d')) }}" required>
    </div>
    <div class="col-12">
    ...
    <div class="text-center">
        ...
        <a href="{{ route('hewan_keluar.index') }}" class="btn btn-secondary">Batal</a>
    </div>
</form>
